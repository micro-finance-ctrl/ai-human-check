(function () {
  ...
  ADS.forEach(ad => {
    ad.size = detectSize(ad.html);
    ad.weight = 1;
    if (ad.size === "468x60") ad.weight += 2;     // PC優先
    if (ad.size === "300x250") ad.weight += 2;   // スマホ優先
  });
